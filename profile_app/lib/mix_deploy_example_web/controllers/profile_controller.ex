defmodule MixDeployExampleWeb.ProfileController do
  ...
  def index(conn, %{"username" => username}) do # , current_user
  ...
  def getprofile(conn, %{"username" => username}) do # current_user
  ...
  def build(conn, %{"user" => user_params}) do
